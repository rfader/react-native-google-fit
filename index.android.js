...
class RNGoogleFit {
  ...
  _retrieveDailyStepCountSamples = (startDate, endDate, bucketMinutes, callback) => {
  ...
  getDailyStepCountSamples = (options, callback) => {
    ...
    const endDate = !isNil(options.endDate)
      ...
      : new Date().valueOf()
    const bucketMinutes = !isNil(options.bucketMinutes) ? parseInt(options.bucketMinutes) : (12 * 60);
    ...
    this._retrieveDailyStepCountSamples(startDate, endDate, bucketMinutes, callback)
  }
